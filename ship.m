...
% n_c     = commanded shaft velocity        (rps)
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Part 3, 1a) Compute new propeller thrust and torque coefficients here
% use the wageningen() function, with correct inputs
%
% The result should look like this:
% [KT,KQ] = wageningen(...);
Ja = 0;
[KT, KQ] = wageningen(Ja, 1.5, 0.65, 4);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
thr = rho*(Dia^4)*KT*abs(n)*n; % hvorfor sto denne her fra før?
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Part 3, 1b,1c) compute torque-based shaft dynamics here
...
Td = U_ref*Xu/(t-1);
nn = Td/(rho*Dia^4 *KT);
nd = sign(nn)*sqrt(abs(nn));
Qd = rho*(Dia^5)*KQ*abs(nd)*nd;
Y = Qd / Km;
